...
- **Intervalo entre explosões (graus do virabrequim)**: só aparece quando cilindros compartilham carburador — define o quanto os pulsos de admissão se espaçam. Default 180° (4-cilindros com firing par). Use 360° pra paralela inglesa clássica, 90° pra V8, etc.
