...
- **Defasagem do virabrequim**: graus entre explosões de cilindros consecutivos — ativo só quando cilindros compartilham carburador. Default 180° (4 cilindros com firing par). Use 360° pra paralela inglesa clássica, 90° pra V8, etc.
